...
document.body.innerHTML += `Qual o Primeiro indice da letra no seu nome?${nome.indexOf('a')}<br/>`
document.body.innerHTML += `Qual o ultimo indice da letra no seu nome?${nome.lastIndexOf('a')}<br/>`;
